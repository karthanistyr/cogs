...
class gw2:
    ...
    async def character(self, ctx, char_name):
        ...
        em = discord.Embed(title=char.object.title.object.name if (char.object.title is not None and char.object.title.has_loaded) else "__{}__".format(self.strings["has_no_title"]))
